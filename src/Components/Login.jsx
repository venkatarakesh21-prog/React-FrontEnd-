  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        // Storing data exactly like your manual login logic
  ...
  return (
    <div className="login-overlay">
      <div className="login-modal">
        ...
        {/* 3. Replace the old static button with the real GoogleLogin component */}
        ...
        <div className="login-form">
          <div className="login-group">
            ...
            />
            {touched.email && errors.email && <span className="login-error">{errors.email}</span>}
          </div>
          ...
          <div className="login-group">
            ...
            {touched.password && errors.password && <span className="login-error">{errors.password}</span>}
          </div>
